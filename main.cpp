...
#pragma region キーボード情報の取得
		...
		for (int i = 0; i < _countof(vertices); i++) {
			...
			vertices[i].x = oldX * affin[0][0] +
				oldY * affin[0][1] + 1.0f * affin[0][2];
			vertices[i].y = oldX * affin[1][0] +
				oldY * affin[1][1] + 1.0f * affin[1][2];
			vertices[i].z = oldX * affin[2][0] +
				oldY * affin[2][1] + 1.0f * affin[2][2];
		}
